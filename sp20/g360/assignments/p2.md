...
1. Your zip file should be named `p2-lastname-firstname.zip` _(e.g., p2-aguirre-nicolas.zip)_. The folder inside should be named `p2-lastname-firstname`.
2. Your sketches should be in a folder named `sketches` and have descriptive names _(e.g., contacts.png, inventory.png)_. You can use multiple files or put them all into one file. Any format is okay.
