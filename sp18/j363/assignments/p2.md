...
<div class="card-block">
  ...
  <a href="shoes/example.png" class="btn btn-primary" target="_blank">View Example</a>
</div>
...
<img src="shoes/images.png" class="tut" alt="images directory">
...
<img src="shoes/getting-images.png" class="tut" alt="images directory">
 ...
 * Your site folder should be named `p2_lastname-firstname` _(e.g., p2_aguirre-nicolas)_
 * You will submit a `.zip` file. Right-click on your site folder and choose `compress`. Make sure this file is called `p2_lastname-firstname.zip`
...
#### **Due Friday March 9th at 11:59pm**
